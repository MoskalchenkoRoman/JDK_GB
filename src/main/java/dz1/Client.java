...
public class Client extends JFrame {
    ...
    JTextField passwordField = new JTextField("Пороль: ");
    ...
    private StringBuffer readLogTFromFile() {
        ...
        try (FileReader reader = new FileReader(Client.FILENAME); BufferedReader brr = new BufferedReader(reader)) {
            ...
            System.out.println("Фаил не найден: " + FILENAME);
        }
        return stringBuffer.append("Фаил не найден:: " + FILENAME + "\n");
    }
}
